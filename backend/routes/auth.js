...
import { addGrade, getUserAverageGradesChart, getUserGradesChart } from '../controllers/subject_gradesController.js';
...
router.get('/grades/chart', verifyToken, getUserAverageGradesChart);
router.get('/grades/progress/:subjectId', verifyToken, getUserGradesChart);
